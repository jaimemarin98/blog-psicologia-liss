...
@Component({
  selector: 'app-section2-adolescence',
  imports: [CommonModule],
  templateUrl: './section2-adolescence.component.html',
  styleUrl: './section2-adolescence.component.css'
})
export class Section2AdolescenceComponent {
