...
@Component({
  selector: 'app-section4-academic-journal',
  imports: [CommonModule],
  templateUrl: './section4-academic-journal.component.html',
  styleUrl: './section4-academic-journal.component.css'
})
export class Section4AcademicJournalComponent {
